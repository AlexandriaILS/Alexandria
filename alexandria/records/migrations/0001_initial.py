    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('searchable_authors', models.CharField(blank=True, db_index=True, max_length=800, null=True)),
                ('searchable_subtitle', models.CharField(blank=True, db_index=True, max_length=26021, null=True)),
                ('searchable_uniform_title', models.CharField(blank=True, db_index=True, max_length=26021, null=True)),
