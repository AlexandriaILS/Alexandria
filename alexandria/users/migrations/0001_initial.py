    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hold_limit', models.IntegerField(blank=True, default=50, help_text='How many active holds is this account type allowed to have?', null=True, verbose_name='hold limit')),
                ('can_checkout_materials', models.BooleanField(default=True, help_text='Allow this account type to check out materials at all.')),
                ('is_staff', models.BooleanField(default=False, help_text='Designates whether users with this role are library staff members.', verbose_name='staff status')),
                ('host', models.CharField(default='default', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host', models.CharField(default='default', max_length=100)),
                ('searchable_first_name', models.CharField(db_index=True, max_length=255)),
                ('searchable_last_name', models.CharField(blank=True, db_index=True, max_length=255, null=True)),
                ('account_type', models.ForeignKey(on_delete=models.SET(alexandria.users.models.get_default_accounttype), to='users.accounttype')),
                ('address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.uslocation')),
            ...
            bases=(alexandria.searchablefields.mixins.SearchableFieldMixin, models.Model),
            managers=[
