...
class SearchableFieldMixin:
    @classmethod
    def get_searchable_field_names(cls) -> list:
        return ["searchable_" + name for name in cls.SEARCHABLE_FIELDS]

    @classmethod
    def get_searchable_field_map(cls) -> dict:
        return {name: "searchable_" + name for name in cls.SEARCHABLE_FIELDS}
